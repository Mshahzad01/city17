        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: TabBarView(
                controller: _tabController,
                children: [_BeddingTab(), const Text('Fixed')],
              ),
            ),
          ],
        ),
...
//Bedding Tab
class _BeddingTab extends StatefulWidget {
  _BeddingTab({super.key});

  @override
  State<_BeddingTab> createState() => _BeddingTabState();
}

class _BeddingTabState extends State<_BeddingTab> {
