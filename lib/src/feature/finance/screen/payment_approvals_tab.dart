...
class PaymentApprovalsTab extends StatefulWidget {
  const PaymentApprovalsTab({super.key});

  @override
  State<PaymentApprovalsTab> createState() => _PaymentApprovalsTabState();
}

class _PaymentApprovalsTabState extends State<PaymentApprovalsTab> {
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          CustomButton(
                            ...
                            fontSize: 12,
                            title: StringData.approveAllPayments,
                            onPressed: () {},
                          ),
                        ],
                      ),
